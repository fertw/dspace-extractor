...
public class NameFinderMETest {
  ...
  public void testNameFinder() throws Exception {
    ...
    InputStream in = new FileInputStream(new File("src/test/resources", "AnnotatedSentences.txt"));
    ...
    TokenNameFinderModel nameFinderModel = NameFinderME.train("en", TYPE, sampleStream,Collections.<String, Object>emptyMap(), 70, 1);
  ...
  public void testOnlyWithEntitiesWithTypes() throws Exception {
    ...
    InputStream in = getClass().getClassLoader().getResourceAsStream("/dspace-extractor/src/test/resources/OnlyWithNamesWithTypes.train");
