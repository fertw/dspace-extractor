...
public class DCInput
{
    ...
    /** is input automatic extract? */
    private boolean automaticExtract = false;
    ...
    public DCInput(Map<String, String> fieldMap, Map<String, List<String>> listMap)
    {
        ...
        String automatic = fieldMap.get("automatic-extract");
        setAutomaticExtract("true".equalsIgnoreCase(automatic)
                || "yes".equalsIgnoreCase(automatic));
	...
	public boolean isAutomaticExtract() {
		return automaticExtract;
	}

	public void setAutomaticExtract(boolean automaticExtract) {
		this.automaticExtract = automaticExtract;
	}
